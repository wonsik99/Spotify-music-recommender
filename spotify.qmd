...
# formalize
target_vector <- c(
  target_profile$target_dance,
  target_profile$target_energy,
  target_profile$target_loudness / 100,  # -60 ~ 0 
  target_profile$target_acoustic,
  target_profile$target_valence,
  target_profile$target_tempo / 200      # 0 ~ 200 
)
...
recommendations <- new_track_attr |>
  ...
  mutate(
    ...
    similarity_score = cosine_similarity(target_vector, unlist(track_vector)),
